...
//  StatementPrinter now has a single responsibility: formatting and printing statements.
//  Previously: AccountService did this, violating SRP.
//  Fix: Extracted into its own class.
public class StatementPrinter {
    ...
    private final Console console; //  Delegates output responsibility
    ...
    //  Builds a single statement line
    ...
    //  Date formatting isolated here
    private String formatDate(LocalDate date) {
        DateTimeFormatter dateFormatter = DateTimeFormatter.ofPattern(DATE_FORMAT);
        return dateFormatter.format(date);
    }

    //  Number formatting isolated here
